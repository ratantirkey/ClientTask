require 'spec_helper'
require_relative '../search_json_value'
...
describe 'search_json_value' do
  it 'should return an array of results when given a valid JSON data and a field to search' do
    ...
    value_to_search = 'john'
    expect(search_data(json_data, field_to_search, value_to_search)).to eq([{ 'name' => 'John' }])
  end
  ...
  it 'should return an empty array when given an empty JSON data and a field to search' do
    ...
    field_to_search = 'name'
    value_to_search = 'john'
    expect(search_data(json_data, field_to_search, value_to_search)).to eq([])
  end
